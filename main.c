...
uint64_t CY_write = 0;
uint64_t CY_read = 0;
uint32_t total_reset = 0;
uint32_t user_reset = 0;

uint64_t Empty_LSB_reset = 0;
uint64_t Empty_CSB_reset = 0;
uint64_t Empty_MSB_reset = 0;

uint64_t CY_LSB_count = 0;
uint64_t CY_CSB_count = 0;
uint64_t CY_MSB_count = 0;

uint64_t CY_LSB_write_count = 0;
uint64_t CY_CSB_write_count = 0;
uint64_t CY_MSB_write_count = 0;

uint32_t active_lsb = 0;
uint32_t active_csb = 0;
uint32_t active_msb = 0;
uint64_t cy_IO = 0;
uint64_t cy_remap = 0;
