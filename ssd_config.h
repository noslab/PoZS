...
#define NAND_4KB_READ_LATENCY_LSB (50000) //ns
#define NAND_4KB_READ_LATENCY_MSB (150000) //ns
#define NAND_4KB_READ_LATENCY_CSB (100000)
#define NAND_READ_LATENCY_LSB (50000)
#define NAND_READ_LATENCY_MSB (150000)
#define NAND_READ_LATENCY_CSB (100000)
...
*/
/*
#define NAND_4KB_READ_LATENCY_LSB (47200)
#define NAND_4KB_READ_LATENCY_MSB (47200)
#define NAND_4KB_READ_LATENCY_CSB (47200)
#define NAND_READ_LATENCY_LSB (47200)
#define NAND_READ_LATENCY_MSB (47200)
#define NAND_READ_LATENCY_CSB (47200)
#define NAND_PROG_LATENCY (533000)
*/

// [CY] TLC mode
#define NAND_4KB_READ_LATENCY_LSB (50000)
#define NAND_4KB_READ_LATENCY_MSB (150000)
#define NAND_4KB_READ_LATENCY_CSB (100000)
#define NAND_READ_LATENCY_LSB (50000)
#define NAND_READ_LATENCY_MSB (150000)
#define NAND_READ_LATENCY_CSB (100000)
...
//#define NAND_ERASE_LATENCY (96000000)		// 96ms (1G)
#define NAND_ERASE_LATENCY (192000000)      // 192ms(2G) 
